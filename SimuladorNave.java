...
public class SimuladorNave {
    ...
    public void iniciarSimulacion() { 
        ...
        escribirConAnimacion( nombreNave + " debe viajar por 5 sectores galácticos hasta llegar a Astraea.", 50);
        ...
        escribirConAnimacion("Introduce la cantidad de energía total disponible para " + nombreNave, 50);
        ...
        while (sector <= 5) {
            ...
            switch (evento) {
                case 0:
                    ...
                    while (true) { 
                        escribirConAnimacion("El módulo de Propulsión ha sufrido un daño, debes utilizar 50 unidades de energía o más para poder repararlo: ", 50);
                ...
                case 1:
                    ...
                    if (intercambio.equals("si")) {
                        int recursoIntercambiado = random.nextInt(30) + 10; 
                ...
                case 2:
                    escribirConAnimacion("Un rayo cósmico ha golpeado la nave, le ha quitado 20 unidades de energía a la nave.", 50);
                    energiaDisponible -= 20; 
                ...
                case 3:
                    ...
                    if (recoleccion.equals("si")) {
                        int recursoRecogido = random.nextInt(20) + 5;
            ...
            if (sector == 3) {
                ...
                while (true) { 
                    escribirConAnimacion("Debes repararlo con 50 unidades de energía o más para poder reparlo: ", 50);
